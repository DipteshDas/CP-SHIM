...
def run():
    ...
    for i in range(len(sample_sizes)):
        ...
        _, cpl_ss, r2_ss = call_method(dir_ms, dir_cv, n_sample=3, name="shim", split=True, ord=14)
        _, cpl_sf, r2_sf = call_method(dir_ms, dir_cv, n_sample=3, name="shim", split=False, ord=14)
