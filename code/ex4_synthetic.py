...
def run():
    ...
    stat_path = "../results/synthetic/stat_ws.npz"
    np.savez(stat_path, data_mlp=data_mlp, data_rf=data_rf, data_lf=data_lf, data_ls=data_ls, data_sf=data_sf,
             data_ss=data_ss, sample_sizes=sample_sizes)

    ylim = (1.5, 6.0)
    xlabel, ylabel, fname = "Sample size", "CI length", "../results/synthetic/figures/cpl_ws.pdf"
